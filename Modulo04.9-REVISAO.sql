...
/*
Nesse módulo, você aprendeu:

A juntar tabelas usando o JOIN.
Modos alternativos de usar o JOIN.
O LEFT JOIN, RIGHT JOIN e FULL JOIN.
Como unir consultas usando o UNION .
A fazer subconsultas usando WHERE, HAVING e IN.
Como usar e mostrar uma VIEW.
*/