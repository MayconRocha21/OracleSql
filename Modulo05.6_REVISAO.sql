...
A usar as funções do SQL.
As funções de string, datas e numéricas.
As funções CONCAT, LOWER, UPPER, INITCAP, LPAD, RPAD, LTRIM, RTRIM, REPLACE e SUBSTR para manipular texto.
Como manipular datas usando as funções SYSDATE, ADD_MONTHS, LASTDAY, MONTHS_BETWEEN e NEXT_DAY.
As funções de conversão TO_CHAR, TO_DATE, TO_NUMBER e NVL.
*/
